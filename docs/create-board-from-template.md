...
3. **Click** [Templates] in the top navigation bar.
    ...
    ![Trello template gallery](../assets/template-gallery.png "The Trello template gallery with categories
    listed on the left.")
...
4. **Type** a keyword into the [Search templates] field, for
   example *project management* or *software*.
    ...
    ![Search templates field with keyword typed in](../assets/template-search.png "The template search field with a keyword entered.")
...
5. **Click** on a template that fits your project to preview it.
    ...
    ![Template preview page](../assets/template-preview.png "A template preview showing its lists and
    sample cards.")
